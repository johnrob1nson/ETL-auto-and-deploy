...
+ Добавляем код, который в конце будет агрегировать данные за день (например, сколько попыток было совершено; сколько успешных попыток было из всех совершенных; количество уникальных юзеров и.т.п.)
